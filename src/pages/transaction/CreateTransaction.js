            ...
            <Modal open={open} onClose={() => setOpen(false)}>
                ...
                >
                    ...
                    >
                        <Form>
                            <Stack spacing={2}>
                                <Field type={'date'} style={{backgroundColor: "lightgray", width: "600px"}}
                                       placeholder={'Time'} autoFocus required name={'time'}/>
                                <Field style={{backgroundColor: "lightgray"}} placeholder={'Total Spent'} required
                                       name={'totalSpent'}/>
                                <Field style={{backgroundColor: "lightgray"}} placeholder={'Note'} required
                                       name={'note'}/>
                                <div>
                                    <div className="form-check form-check-inline">
                                        <input onChange={(event) => {
                                            setIncome(event.target.value)
                                               ...
                                               id="inlineRadio1" defaultValue="thu" style={{padding: '8px 8px'}}/>
                                    ...
                                    <div className="form-check form-check-inline">
                                        <input onChange={(event) => {
                                            setIncome(event.target.value)
                                               ...
                                               id="inlineRadio2" defaultValue="chi" style={{padding: '8px 8px'}}/>
