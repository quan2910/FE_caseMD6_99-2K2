...
export default function Home() {
    ...
    const showDate = () => {
        if (flag == false) {
            return <div style={{
                ...
                textAlign: "center",
                fontWeight: "bold"
            }}>{dataDate.fromDate} -> {dataDate.toDate}</div>
        } else {
            return ''
        }
    }
    ...
    let index= 1
    let arr=[]
let arrExportExcel = [...detailWalletHome.transactions]
    for (let arrExportExcelElement of arrExportExcel) {
        let a = {
            stt:index++,
            note :arrExportExcelElement.note,
            time :arrExportExcelElement.time,
            totalSpent:arrExportExcelElement.totalSpent,
            nameCategory:arrExportExcelElement.nameCategory
        }
        arr.push(a)
    }
            ...
            <div className="about-me containerTemplate" style={{marginTop: -35}}>
                <div className="row">
                    <div className="col-3" style={{marginTop: "28px"}}>
                        <h5 style={{textAlign: "center", color: "white", fontWeight: "bold", marginBottom: -90}}>Find
                            Transaction</h5>
                        ...
                        <div className="row">
                            <div className="col-lg-4">
                                ...
                                <h5 style={{color: "black", marginTop: 23, marginLeft: 0, fontWeight: "bold"}}>
                                    TotalMoney
                                    : {totalConsumableMoney().total.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}{wallets.nameMoneyType} {handleTypeMoney()}
                                </h5>
                            </div>
                            <div className="col-lg-4"  >
                            ...
                            <div className="col-lg-4">
                                ...
                                style={{color: "black"}}>Expenditure: {totalConsumableMoney().ConsumableMoney.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} {handleTypeMoney()}</strong>
                                <input
                                    style={{
                                        background: "white",
                                        color: "blue",
                            ...
                            <div className="col-lg-4">
                                ...
                                style={{color: "black"}}>Revenue: {totalConsumableMoney().moneyIncome.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} {handleTypeMoney()}</strong>
                            </div>
                                ...
                                <table ref={tableRef} className="table table-striped" style={{marginTop: 10}}>
                                    ...
                                    {currentPosts.map((transaction, index) => {
                                        return <tr>
                                            ...
                                            <td style={{}}><EditTransaction date={month}
                                                                            idTransaction={transaction.idTransaction}
                                                                            idWallet={detailWalletHome.wallet[0].idWallet}></EditTransaction>
                                            </td>
                                            <td style={{textAlign: "center"}}><DeleteTransaction date={month}
                                                                                                 idTransaction={transaction.idTransaction}></DeleteTransaction>
                                            </td>
            ...
            <div style={{width: 300, marginTop: -280}}>
                ...
                <div className={"row"}>
                    ...
                    <div style={{textAlign: "center", color: "black"}}
                         className="custom-control custom-radio col-4">Revenue
                        <input
                            type="radio"
                            className="custom-control-input"
                            id="defaultChecked"
