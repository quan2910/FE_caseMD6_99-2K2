                               ...
                               <Form>
                                   <div className="card-body">
                                       <div className="row">
                                           ...
                                           <div className="col-sm-9 text-secondary" ><Field name={'fullName'} type={'text'} style={{width:"300px",height:"40px"}} /></div>
                                       </div>
                                       <hr />
                                       <div className="row">
                                           <div className="col-sm-3">
                                           ...
                                           <div className="col-sm-9 text-secondary" ><Field name={'age'} type={"number"} style={{width:"300px",height:"40px"}} /></div>
                                       </div>
                                       <hr />
                                       <div className="row">
                                           <div className="col-sm-3">
                                           ...
                                           <div className="col-sm-9 text-secondary" ><Field name={'phone'}  type={'text'} style={{width:"300px",height:"40px"}} /></div>
                                       </div>
                                       <hr />
                                       <div className="row">
                                           <div className="col-sm-3">
                                           ...
                                           <div className="col-sm-9 text-secondary" ><Field name={'address'}  type={'text'} style={{width:"300px",height:"40px"}} /></div>
                                       </div>
                                       <hr />
                                       <div className="row">
